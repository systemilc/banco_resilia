...
CREATE TABLE `comunidade` (
  ...
  `usuario_discord` varchar(255) DEFAULT NULL,
  ...
  CONSTRAINT `comunidade_ibfk_1` FOREIGN KEY (`turma_id`) REFERENCES `turmas` (`id`),
  CONSTRAINT `comunidade_ibfk_2` FOREIGN KEY (`aluno_id`) REFERENCES `estudantes` (`id`)
